...
def DFS_edge_names(graph):
    ...
    for i in order:
        for u in vertices:
            if u.index == i:
                pred = None if u.predecessor == None else u.predecessor.index
                print(f'vertex = {u.index}, v.d = {u.d}, v.f = {u.f}, v.p = {pred}')
...
if __name__ == '__main__':
    ...
    """
    # The input file for the Assignment 3, task 3
    file_vertx = "./Ass3_input.txt"
    # The input for the arbitrary size graph, generated by the subprogram generate_input.py
